      ...
      if (switch_showLable === true) {
        ...
        svg.append("g")
          ...
          .each(function(d, i) {
            ...
            if (!isNaN(textValue) && textValue > 0) { // Only display text if value is not NaN and > 0
              svg.append("text")
          ...
          groups.forEach((group, i) => {
            const total = stackedData.reduce((sum, d) => sum + (d[i][1] - d[i][0]), 0);
